...
{
    class HockeyLeagueGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        protected void onDoMysteryScatter(int agentID, string strUserID, GITMessage message, UserBonus userBonus, double userBalance)
        {
            ...
            {
                _logger.Error("Exception has been occurred in HockeyLeagueGameLogic::onDoMysteryScatter {0}", ex);
            }
        }
