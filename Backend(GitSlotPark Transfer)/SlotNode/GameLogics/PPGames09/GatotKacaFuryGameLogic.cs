...
{
    class GatotKacaFuryBetInfo : BasePPSlotBetInfo
    {
    ...
    class GatotKacaFuryGameLogic : BasePPSlotGame
    {
        ...
        {
            get { return new double[] { 100, 200, 300 }; }
        }
        #endregion
        public GatotKacaFuryGameLogic()
        {
            _gameID  = GAMEID.GatotKacaFury;
            GameName = "GatotKacaFury";
        }
        ...
        {
            int purchaseType = (betInfo as GatotKacaFuryBetInfo).PurchaseType;
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strUserID)
        {
            try
            {
                GatotKacaFuryBetInfo betInfo = new GatotKacaFuryBetInfo();
                ...
                {
                    _logger.Error("{0} betInfo.MoreBet and  PurchasedFreeSpin is same time true in GatotKacaFuryGameLogic::readBetInfoFromMessage", strUserID);
                    return;
                }
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in GatotKacaFuryGameLogic::readBetInfoFromMessage {1}", strUserID, betInfo.BetPerLine);
                    return;
                }
                ...
                if (_dicUserBetInfos.TryGetValue(strUserID, out oldBetInfo))
                {
                    ...
                    (oldBetInfo as GatotKacaFuryBetInfo).PurchaseType = betInfo.PurchaseType;
                }
                else
                {
            ...
            {
                _logger.Error("Exception has been occurred in GatotKacaFuryGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
        ...
        {
            return new GatotKacaFuryBetInfo();
        }
        ...
        protected override async Task<BasePPSlotSpinData> selectMinStartFreeSpinData(BasePPSlotBetInfo betInfo)
        {
            ...
            {
                _logger.Error("Exception has been occurred in GatotKacaFuryGameLogic::selectMinStartFreeSpinData {0}", ex);
                return null;
            }
        }
        protected override async Task<BasePPSlotSpinData> selectRandomStartFreeSpinData(BasePPSlotBetInfo betInfo)
        {
            ...
            {
                _logger.Error("Exception has been occurred in GatotKacaFuryGameLogic::selectRandomStartFreeSpinData {0}", ex);
                return null;
            }
        }
        ...
        {
            GatotKacaFuryBetInfo gatotBetInfo = betInfo as GatotKacaFuryBetInfo;
            return new UserSpinItem(agentID, strUserID, this.SymbolName, betInfo.BetPerLine, betInfo.LineCount, betInfo.MoreBet ? 1 : 0, betInfo.PurchaseFree ? gatotBetInfo.PurchaseType : -1, betMoney);
        }
    }
}
