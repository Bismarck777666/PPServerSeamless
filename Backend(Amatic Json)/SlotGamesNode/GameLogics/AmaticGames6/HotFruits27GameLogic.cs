...
{
    public class HotFruits27BetInfo : BaseAmaticSlotBetInfo
    {
        public override int RelativeTotalBet    => 1;
    }

    class HotFruits27GameLogic : BaseAmaticSlotGame
    {
        #region 게임고유속성값
        ...
        public HotFruits27GameLogic()
        {
            _gameID     = GAMEID.HotFruits27;
            GameName    = "HotFruits27";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strUserID, Currencies currency)
        {
            try
            {
                HotFruits27BetInfo betInfo   = new HotFruits27BetInfo();
                ...
                {
                    _logger.Error("{0} betInfo 0 or infinite in HotFruits27GameLogic::readBetInfoFromMessage", strUserID);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in HotFruits27GameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
