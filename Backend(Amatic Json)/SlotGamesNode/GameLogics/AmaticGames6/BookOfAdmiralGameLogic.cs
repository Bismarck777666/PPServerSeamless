...
namespace SlotGamesNode.GameLogics
{
    ...
    class BookOfAdmiralGameLogic : BaseAmaticSlotGame
    {
        ...
        protected override string buildInitString(string strUserID, double balance, Currencies currency)
        {
            ...
            BookOfAdmiralInitPacket respinInitPacket = new BookOfAdmiralInitPacket(initString, Cols, FreeCols, ReelSetBitNum);
        ...
        public class BookOfAdmiralInitPacket : InitPacket
        {
            ...
            public BookOfAdmiralInitPacket(string message, int reelCnt, int freeReelCnt, int reelsetBitCnt) : base(message, reelCnt, freeReelCnt, reelsetBitCnt)
            {
                extrawin    = 0;
                extrastr    = "091010101010101010101900000000019000000000";
                curpoint    = curpoint + 2 + extrastr.Length;
