...
namespace SlotGamesNode.GameLogics
{
    ...
    class GemStarGameLogic : BaseAmaticMultiBaseGame
    {
        ...
        protected override string buildInitString(string strUserID, double balance, Currencies currency)
        {
            ...
            GemStarInitPacket gemstarInitPacket = new GemStarInitPacket(initString, Cols, FreeCols, ReelSetBitNum);
        ...
        public class GemStarInitPacket : InitPacket
        {
            ...
            public GemStarInitPacket(string message, int reelCnt, int freeReelCnt, int reelsetBitCnt) : base(message, reelCnt, freeReelCnt, reelsetBitCnt)
            {
                extrawin = 0;
                extracnt = 0;
                extrastr = "0101010101";
