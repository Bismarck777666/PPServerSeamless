...
namespace SlotGamesNode.GameLogics
{
    ...
    class GrandXGameLogic : BaseAmaticSlotGame
    {
        ...
        protected override string buildInitString(string strUserID, double balance, Currencies currency)
        {
            ...
            GrandXInitPacket grandInitPacket = new GrandXInitPacket(initString, Cols, FreeCols, ReelSetBitNum);
        ...
        public class GrandXInitPacket : InitPacket
        {
            ...
            public GrandXInitPacket(string message, int reelCnt, int freeReelCnt, int reelsetBitCnt) : base(message, reelCnt, freeReelCnt, reelsetBitCnt)
            {
                extrawin        = 0;
                extramultiple   = 0;
                curpoint        = curpoint + 2 + 2;
