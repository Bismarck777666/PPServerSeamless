...
{
    public class HotDice27BetInfo : BaseAmaticSlotBetInfo
    {
        public override int RelativeTotalBet    => 1;
    }

    class HotDice27GameLogic : BaseAmaticSlotGame
    {
        #region 게임고유속성값
        ...
        public HotDice27GameLogic()
        {
            _gameID     = GAMEID.HotDice27;
            GameName    = "Hot27Dice";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strUserID, Currencies currency)
        {
            try
            {
                HotDice27BetInfo betInfo   = new HotDice27BetInfo();
                ...
                {
                    _logger.Error("{0} betInfo 0 or infinite in HotDice27GameLogic::readBetInfoFromMessage", strUserID);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in HotDice27GameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
