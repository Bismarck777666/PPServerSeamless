...
{
    class BurningBells20DiceGameLogic : BaseAmaticSlotGame
    {
        #region 게임고유속성값
        ...
        public BurningBells20DiceGameLogic()
        {
            _gameID     = GAMEID.BurningBells20Dice;
            GameName    = "BurningBells20Dice";
        }
    }
}
