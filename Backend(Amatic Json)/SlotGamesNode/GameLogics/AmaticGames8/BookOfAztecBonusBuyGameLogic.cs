...
namespace SlotGamesNode.GameLogics
{
    class BookOfAztecBonusBuyGameLogic : BaseAmaticSlotGame
    {
        ...
        protected override string buildInitString(string strUserID, double balance, Currencies currency)
        {
            ...
            BookOfAztecBonusBuyInitPacket initPacket = new BookOfAztecBonusBuyInitPacket(initString, Cols, FreeCols, ReelSetBitNum, (int)LINES.Last());
        ...
        public class BookOfAztecBonusBuyInitPacket : InitPacket
        {
            ...
            public BookOfAztecBonusBuyInitPacket(string message, int reelCnt, int freeReelCnt, int reelsetBitCnt, int lines) : base(message, reelCnt, freeReelCnt, reelsetBitCnt)
            {
                extrawildsymbol = 0;
                extracolcnt     = 0;
                extrawin        = 0;
