...
namespace CommNode.Database
{
    public class DBMonitorSnapshot
    {
        ...
        public long             LastScoreID                 { get; set; }
        ...
        public DateTime         LastServerStatesUpdateTime  { get; set; }
        ...
        public DBMonitorSnapshot()
        {
            ...
            this.LastTurboSpeedUpdateTime       = new DateTime(1, 1, 1);
            this.TurboSpeed                     = 0.0;
