...
namespace QueenApiNode.Agent
{
    ...
    public class CreateNewAgentActorMsg
    {
        ...
        public CreateNewAgentActorMsg(int dbID, string strAgentID, string authToken, double balance, int currency,IActorRef dbReader, IActorRef dbWriter)
        {
            this.AgentDBID  = dbID;
    ...
    {
        public string AgentID { get; private set; }
        public GetAgentActorMsg(string strAgentID)
        {
            this.AgentID = strAgentID;
        }
    }
