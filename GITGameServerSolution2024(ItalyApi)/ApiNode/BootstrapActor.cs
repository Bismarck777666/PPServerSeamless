    ...
    public class BootstrapActor : ReceiveActor
    {
        ...
        public BootstrapActor(Config configuration)
        {
            ...
            Receive<DBProxy.ReadyDBProxy>(dbActors =>
            {
                ...
                var userFrontConfig = _configuration.GetConfig("userFront");
                if(userFrontConfig != null)
                {
                    ApiConfig.UserFrontUrl = userFrontConfig.GetString("url");
                }
                ...
                var adminConfig = _configuration.GetConfig("adminApi");
                if (adminConfig != null)
                    ApiConfig.AdminTokenKey = adminConfig.GetString("tokenkey");
            });
