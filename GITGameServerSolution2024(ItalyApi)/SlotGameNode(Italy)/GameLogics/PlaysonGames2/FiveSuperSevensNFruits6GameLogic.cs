...
{
    class FiveSuperSevensNFruits6GameLogic : BasePlaysonSlotGame
    {
        #region 게임고유속성값
        protected override string SymbolName
        {
            get
            {
                return "5_super_sevens_n_fruits_6r";
            }
        }
