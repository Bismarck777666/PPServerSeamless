...
namespace SlotGamesNode.GameLogics
{
    ...
    class ThorGameLogic : BaseCQ9SlotGame
    {
        #region 게임고유속성값
        ...
        protected override int[] BetButton
        {
            get
            {
                return new int[] { 125, 250, 500, 750, 1250, 2500, 5000, 12500, 25000, 1, 2, 5, 10, 30, 50, 80 };
            }
        }
