...
namespace SlotGamesNode.GameLogics
{
    ...
    class GuGuGu2GameLogic : BaseSelFreeCQ9RespinSlotGame
    {
        #region 게임고유속성값
        ...
        protected override string CQ9GameNameSet
        {
            get
            {
                return "[{lang: \"zh-cn\", \"name\": \"金鸡报囍2\"}," +
                    "{ \"lang\": \"en\", \"name\": \"Gu Gu Gu 2\"}," +
                    "{ \"lang\": \"ko\", \"name\": \"Gu Gu Gu 2\"}," +
                    "{ \"lang\": \"th\", \"name\": \"ปีใหม่ ไก่กุ๊กกุ๊ก 2\"}," +
                    "{ \"lang\": \"vn\", \"name\": \"Năm Đinh Dậu 2\"}," +
                    "{ \"lang\": \"id\", \"name\": \"New Year Rooster 2\"}," +
                    "{ \"lang\": \"es\", \"name\": \"Gu Gu Gu 2\"}]";
            }
        }
        ...
        public GuGuGu2GameLogic()
        {
            _initData.BetButton         = BetButton;
            _initData.MaxBet            = MaxBet;
            _gameID                     = GAMEID.GuGuGu2;
            GameName                    = "GuGuGu2";
        }
        ...
        protected override async Task<BaseCQ9SlotSpinResult> generateSpinResult(BaseCQ9SlotBetInfo betInfo, string strUserID, int agentID, UserBonus userBonus, bool usePayLimit, bool isMustLose)
        {
            ...
            if (betInfo.HasRemainResponse || betInfo.ReelPay == 0 || _dicUserResultInfos[strGlobalUserID] == null)
            ...
            SortedDictionary<double, List<BaseCQ9SlotSpinResult>> dicAllEmptyResults            = getAllAvailableSpinResults(2, _dicUserResultInfos[strGlobalUserID], betInfo,false);
            SortedDictionary<double, List<BaseCQ9SlotSpinResult>> dicAllFreeStartSpinResults    = getAllAvailableSpinResults(2, _dicUserResultInfos[strGlobalUserID], betInfo,true);
