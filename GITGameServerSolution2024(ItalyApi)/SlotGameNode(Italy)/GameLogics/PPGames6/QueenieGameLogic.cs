                    ...
                    else
                    {
                        ...
                        if(ind >= 0)
                        {
                            ...
                            if (result.BonusSelections.Contains(ind))
                                throw new Exception("User selected already selected position, Malicious Behavior");
