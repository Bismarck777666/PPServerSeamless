...
namespace SlotGamesNode.GameLogics
{
    ...
    class BaseAmaticExtra3Game : BaseAmaticSlotGame
    {
        protected override string buildInitString(string strGlobalUserID, double balance, CurrencyEnum currency)
        {
            ...
            BaseAmaticExtra3InitPacket initPacket = new BaseAmaticExtra3InitPacket(initString, Cols, FreeCols, ReelSetBitNum, (int)LINES.Last());
        ...
        public class BaseAmaticExtra3InitPacket : InitPacket
        {
            ...
            public BaseAmaticExtra3InitPacket(string message, int reelCnt, int freeReelCnt, int reelsetBitCnt, int lines) : base(message, reelCnt, freeReelCnt, reelsetBitCnt)
            {
                extrawildsymbol = 0;
                extracolcnt     = 0;
                extrawin        = 0;
