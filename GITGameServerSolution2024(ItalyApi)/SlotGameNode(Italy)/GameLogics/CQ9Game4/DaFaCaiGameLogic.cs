...
namespace SlotGamesNode.GameLogics
{
    ...
    class DaFaCaiGameLogic : BaseCQ9SlotGame
    {
        #region 게임고유속성값
        ...
        protected override int[] BetButton
        {
            get
            {
                return new int[] { 60, 120, 250, 360, 600, 1200, 2500, 1, 2, 4, 5, 10, 20, 30 };
            }
        }
        ...
        protected override string CQ9GameNameSet
        {
            get
            {
                return "[{\"lang\":\"en\",\"name\":\"Da Fa Cai\"}," +
                    "{\"lang\":\"es\",\"name\":\"Da Fa Cai\"}," +
                    "{\"lang\":\"id\",\"name\":\"Da Fa Cai\"}," +
                    "{\"lang\":\"ja\",\"name\":\"Da Fa Cai\"}," +
                    "{\"lang\":\"ko\",\"name\":\"Da Fa Cai\"}," +
                    "{\"lang\":\"th\",\"name\":\"Da Fa Cai\"}," +
                    "{\"lang\":\"vn\",\"name\":\"Da Fa Cai\"}," +
                    "{\"lang\":\"zh-cn\",\"name\":\"Da Fa Cai\"}]";
            }
        }

        #endregion

        public DaFaCaiGameLogic()
        {
            _initData.BetButton     = BetButton;
            _initData.DenomDefine   = DenomDefine;
            _initData.MaxBet        = MaxBet;
            _gameID                 = GAMEID.DaFaCai;
            GameName                = "DaFaCai";
        }
    }
}
