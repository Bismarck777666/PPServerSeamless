...
namespace SlotGamesNode.GameLogics
{
    ...
    class DaHongZhongGameLogic : BaseCQ9SlotGame
    {
        #region 게임고유속성값
        ...
        protected override string CQ9GameNameSet
        {
            get
            {
                return "[{\"lang\":\"en\",\"name\":\"Da Hong Zhong\"}," +
                    "{\"lang\":\"es\",\"name\":\"Da Hong Zhong\"}," +
                    "{\"lang\":\"id\",\"name\":\"Da Hong Zhong\"}," +
                    "{\"lang\":\"ja\",\"name\":\"Da Hong Zhong\"}," +
                    "{\"lang\":\"ko\",\"name\":\"Da Hong Zhong\"}," +
                    "{\"lang\":\"th\",\"name\":\"Da Hong Zhong\"}," +
                    "{\"lang\":\"vn\",\"name\":\"Da Hong Zhong\"}," +
                    "{\"lang\":\"zh-cn\",\"name\":\"Da Hong Zhong\"}]";
            }
        }

        #endregion

        public DaHongZhongGameLogic()
        {
            _initData.BetButton     = BetButton;
            _initData.DenomDefine   = DenomDefine;
            _initData.MaxBet        = MaxBet;
            _gameID                 = GAMEID.DaHongZhong;
            GameName                = "DaHongZhong";
        }
    }
}
