...
namespace SlotGamesNode.GameLogics
{
    ...
    class SherlockHolmesGameLogic : BaseSelFreeCQ9SlotGame
    {
        ...
        protected override string CQ9GameNameSet
        {
            get
            {
                return "[{\"lang\":\"en\",\"name\":\"Sherlock Holmes\"}," +
                    "{\"lang\":\"id\",\"name\":\"Sherlock Holmes\"}," +
                    "{\"lang\":\"pt-br\",\"name\":\"Sherlock Holmes\"}," +
        ...
        public SherlockHolmesGameLogic()
        {
            _initData.BetButton     = BetButton;
            _initData.DenomDefine   = DenomDefine;
            _initData.MaxBet        = MaxBet;
            _gameID                 = GAMEID.SherlockHolmes;
            GameName                = "SherlockHolmes";
        }
    }
}
