...
{
    public class QueenOfQueens1024GameLogic : BaseHabanero1SlotGame
    {
        #region 게임고유속성값
        ...
        protected override string BrandGameId
        {
            get
            {
                return "69a8ab01-0264-48b5-b8fa-1a26120147de";
            }
        }
        ...
        public QueenOfQueens1024GameLogic()
        {
            _gameID     = GAMEID.QueenOfQueens1024;
            GameName    = "QueenOfQueens1024";
        }
