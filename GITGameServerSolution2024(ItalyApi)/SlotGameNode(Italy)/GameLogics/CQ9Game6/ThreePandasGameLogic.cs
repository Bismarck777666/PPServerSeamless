...
namespace SlotGamesNode.GameLogics
{
    ...
    class ThreePandasGameLogic : BaseCQ9MultiBaseGame
    {
        #region 게임고유속성값
        ...
        protected override string CQ9GameNameSet
        {
            get
            {
                return "[{\"lang\":\"en\",\"name\":\"Three Pandas\"}," +
                    "{\"lang\":\"ko\",\"name\":\"Three Pandas\"}]";
            }
        }
        ...
        public ThreePandasGameLogic()
        {
            _initData.BetButton     = BetButton;
            _initData.DenomDefine   = DenomDefine;
            _initData.MaxBet        = MaxBet; 
            _gameID                 = GAMEID.ThreePandas;
            GameName                = "ThreePandas";
        }
    }
}
