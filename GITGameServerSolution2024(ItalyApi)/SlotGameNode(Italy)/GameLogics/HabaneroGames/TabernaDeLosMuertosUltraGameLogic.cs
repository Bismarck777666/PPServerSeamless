...
{
    public class TabernaDeLosMuertosUltraGameLogic : BaseHabaneroSlotGame
    {
        #region 게임고유속성값
        protected override string SymbolName
        {
            get
            {
                return "SGTabernaDeLosMuertosUltra";
            }
        }
        protected override string BrandGameId
        {
            get
            {
                return "b607c136-6ac2-4a2a-b4aa-b2452ddf1d19";
            }
        }
        ...
        public TabernaDeLosMuertosUltraGameLogic()
        {
            _gameID     = GAMEID.TabernaDeLosMuertosUltra;
            GameName    = "TabernaDeLosMuertosUltra";
        }
