...
namespace SlotGamesNode
{
    public class SlotGamesService
    {
        ...
        public bool Start()
        {
            ...
            var cq9Config = slotGamesConfig.GetConfig("cq9");
            CQ9Config.Instance.HistoryURL = cq9Config.GetString("historyurl", "");

            var habaneroConfig = slotGamesConfig.GetConfig("habanero");
            HabaneroConfig.Instance.ReplayURL = habaneroConfig.GetString("replayurl", "");
