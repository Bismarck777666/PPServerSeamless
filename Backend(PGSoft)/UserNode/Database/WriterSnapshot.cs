...
namespace UserNode.Database
{
    ...
    public class ApiTransactionItem 
    {
        ...
        public ApiTransactionItem(string agentID, string userID, int gameID, double betAmount, double winAmount, string transactionID, string relTransactionID, string platformTransID, string roundID, bool endTransaction, TransactionTypes transactionType, DateTime timestamp)
        {
            this.AgentID            = agentID;
            this.UserID             = userID;
            this.GameID             = gameID;
    ...
    public class FailedTransactionItem
    {
        ...
        public FailedTransactionItem(string agentID, string userID, TransactionTypes transactionType, string transactionID, string refTransactionID, bool endTransaction, double betAmount, double winAmount, int gameID, DateTime updateTime)
        {
            this.AgentID            = agentID;
            this.UserID             = userID;
            this.TransactionType    = transactionType;
