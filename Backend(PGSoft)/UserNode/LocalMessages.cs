...
{            
    ...
    public class PGBetHistoryRequest : IConsistentHashable
    {
        ...
        public PGBetHistoryRequest(int agentID, string userID, int gameID, long startTime, long endTime, int pageNumber, int countPerPage)
        {
            AgentID      = agentID;
            UserID       = userID;
            GameID       = gameID;
    ...
    public class PGBetHistoryDetailRequest : IConsistentHashable
    {
        public int      AgentID         { get; private set; }
        public string   UserID          { get; private set; }
        public int      GameID          { get; private set; }
        public long     SpinRoundID     { get; private set; }
        public object ConsistentHashKey
        {
            get
            {
        ...
        public PGBetHistoryDetailRequest(int agentID, string userID, int gameID, long spinRoundID)
        {
            AgentID         = agentID;
            UserID          = userID;
            GameID          = gameID;
            SpinRoundID     = spinRoundID;
        }
    }
    public class PGBetSummaryRequest : IConsistentHashable
    {
        ...
        public PGBetSummaryRequest(int agentID, string userID, int gameID, long startTime, long endTime)
        {
            AgentID     = agentID;
            UserID      = userID;
            GameID      = gameID;
