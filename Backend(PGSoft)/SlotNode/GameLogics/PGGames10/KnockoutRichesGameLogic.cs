...
{
    internal class KnockoutRichesGameLogic : BasePGSlotGame
    {
        ...
        protected override string DefaultResult
        {
            get
            {
                return "{\"si\":{\"wp\":null,\"lw\":null,\"snww\":null,\"ssaw\":0,\"rns\":null,\"orl\":[9,8,6,10,3,7,5,9,10,6,7,10,8,7,9,6,10,11],\"sc\":0,\"skc\":[-1,-1,-1],\"skcb\":[-1,-1,-1],\"fw\":0,\"crtw\":0,\"imw\":false,\"fs\":null,\"ss\":null,\"ifp\":false,\"now\":1,\"pnow\":1,\"nowpr\":[3,4,4,4,3],\"gwt\":-1,\"pmt\":null,\"ab\":null,\"ml\":1,\"cs\":0.05,\"rl\":[9,8,6,10,3,7,5,9,10,6,7,10,8,7,9,6,10,11],\"ctw\":0,\"cwc\":0,\"fstc\":null,\"pcwc\":0,\"rwsp\":null,\"hashr\":null,\"fb\":null,\"sid\":\"1935011577744880643\",\"psid\":\"1935011577744880643\",\"st\":1,\"nst\":1,\"pf\":1,\"aw\":0,\"wid\":0,\"wt\":\"C\",\"wk\":\"0_C\",\"wbn\":null,\"wfg\":null,\"blb\":290239.07,\"blab\":290238.07,\"bl\":291590.57,\"tb\":1,\"tbb\":1,\"tw\":0,\"np\":-1,\"ocr\":null,\"mr\":null,\"ge\":[1,11]}}";
            }
        }
        ...
        public KnockoutRichesGameLogic()
        {
            _gameID     = GAMEID.KnockoutRiches;
            GameName    = "KnockoutRiches";
        }
        ...
        protected override void convertWinsByBet(dynamic jsonParams, float currentBet)
        {
            ...
            if (!IsNullOrEmpty(jsonParams["fw"]))
                jsonParams["fw"] = convertWinByBet((double)jsonParams["fw"], currentBet);
        }
    }
}
