...
namespace SlotGamesNode.GameLogics
{
    class Genies3WishesGameLogic : BasePGSlotGame
    {
        ...
        {
            get { return "{\"wp\":null,\"lw\":null,\"snww\":null,\"lwm\":null,\"wslw\":null,\"orl\":[9,3,2,6,11,8,5,2,13,7,12,9,8,4,2],\"twbm\":0.0,\"sc\":0,\"twf\":null,\"fs\":null,\"gwt\":-1,\"fb\":null,\"ctw\":0.0,\"pmt\":null,\"cwc\":0,\"fstc\":null,\"pcwc\":0,\"rwsp\":null,\"hashr\":null,\"ml\":10,\"cs\":0.01,\"rl\":[9,3,2,6,11,8,5,2,13,7,12,9,8,4,2],\"sid\":\"1762870587786528258\",\"psid\":\"1762870587786528258\",\"st\":1,\"nst\":1,\"pf\":1,\"aw\":0.0,\"wid\":0,\"wt\":\"C\",\"wk\":\"0_C\",\"wbn\":null,\"wfg\":null,\"blb\":0.0,\"blab\":0.0,\"bl\":0.0,\"tb\":0.0,\"tbb\":0.0,\"tw\":0.0,\"np\":0.0,\"ocr\":null,\"mr\":null,\"ge\":[1,11]}"; }
        }
        ...
        private void onFreespinSelect(string strUserID, int websiteID, GITMessage message, double userBalance, BasePGSlotBetInfo betInfo, BasePGSlotStartSpinData startSpinData, bool isAffiliate)
        {
            try
            {
                ...
                if (!_dicUserResultInfos.ContainsKey(strGlobalUserID) || uft < 0 || uft > 2)
                    return;
