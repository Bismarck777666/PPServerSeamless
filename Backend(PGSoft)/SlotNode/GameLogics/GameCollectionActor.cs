...
using BackendServer.GameLogics;
...
namespace SlotGamesNode.GameLogics
{
    public class GameCollectionActor : ReceiveActor
    {
        ...
        protected void createGameLogicActors()
        {
            ...
            _dicGameLogicActors.Add(GAMEID.GemstonesGold,       Context.ActorOf(Props.Create(() => new GemstonesGoldGameLogic()),           "GemstonesGold"));
            _dicGameLogicActors.Add(GAMEID.CashMania,           Context.ActorOf(Props.Create(() => new CashManiaGameLogic()),               "CashMania"));
            _dicGameLogicActors.Add(GAMEID.WildApe3258,         Context.ActorOf(Props.Create(() => new WildApe3258GameLogic()),             "WildApe3258"));
            _dicGameLogicActors.Add(GAMEID.PinataWins,          Context.ActorOf(Props.Create(() => new PinataWinsGameLogic()),              "PinataWins"));
            _dicGameLogicActors.Add(GAMEID.MysticPotion,        Context.ActorOf(Props.Create(() => new MysticPotionGameLogic()),            "MysticPotion"));
            _dicGameLogicActors.Add(GAMEID.AnubisWrath,         Context.ActorOf(Props.Create(() => new AnubisWrathGameLogic()),             "AnubisWrath"));
            _dicGameLogicActors.Add(GAMEID.ZombieOutbreak,      Context.ActorOf(Props.Create(() => new ZombieOutbreakGameLogic()),          "ZombieOutbreak"));
            
            _dicGameLogicActors.Add(GAMEID.SharkHunter,         Context.ActorOf(Props.Create(() => new SharkHunterGameLogic()),             "SharkHunter"));
            _dicGameLogicActors.Add(GAMEID.YakuzaHonor,         Context.ActorOf(Props.Create(() => new YakuzaHonorGameLogic()),             "YakuzaHonor"));
            _dicGameLogicActors.Add(GAMEID.WingsOfIguazu,       Context.ActorOf(Props.Create(() => new WingsOfIguazuGameLogic()),           "WingsOfIguazu"));
            _dicGameLogicActors.Add(GAMEID.ThreeCrazyPiggies,   Context.ActorOf(Props.Create(() => new ThreeCrazyPiggiesGameLogic()),       "ThreeCrazyPiggies"));
            _dicGameLogicActors.Add(GAMEID.OishiDelights,       Context.ActorOf(Props.Create(() => new OishiDelightsGameLogic()),           "OishiDelights"));
            _dicGameLogicActors.Add(GAMEID.MuseumMystery,       Context.ActorOf(Props.Create(() => new MuseumMysteryGameLogic()),           "MuseumMystery"));
            _dicGameLogicActors.Add(GAMEID.RioFantasia,         Context.ActorOf(Props.Create(() => new RioFantasiaGameLogic()),             "RioFantasia"));
            _dicGameLogicActors.Add(GAMEID.ChocolateDeluxe,     Context.ActorOf(Props.Create(() => new ChocolateDeluxeGameLogic()),         "ChocolateDeluxe"));
            _dicGameLogicActors.Add(GAMEID.GeishasRevenge,      Context.ActorOf(Props.Create(() => new GeishasRevengeGameLogic()),          "GeishasRevenge"));
            _dicGameLogicActors.Add(GAMEID.FortuneSnake,        Context.ActorOf(Props.Create(() => new FortuneSnakeGameLogic()),            "FortuneSnake"));
            _dicGameLogicActors.Add(GAMEID.IncanWonders,        Context.ActorOf(Props.Create(() => new IncanWondersGameLogic()),            "IncanWonders"));
            _dicGameLogicActors.Add(GAMEID.MrTreasuresFortune,  Context.ActorOf(Props.Create(() => new MrTreasuresFortuneGameLogic()),      "MrTreasuresFortune"));
            _dicGameLogicActors.Add(GAMEID.GraffitiRush,        Context.ActorOf(Props.Create(() => new GraffitiRushGameLogic()),            "GraffitiRush"));
            _dicGameLogicActors.Add(GAMEID.DoomsdayRampage,     Context.ActorOf(Props.Create(() => new DoomsdayRampageGameLogic()),         "DoomsdayRampage"));
            _dicGameLogicActors.Add(GAMEID.KnockoutRiches,      Context.ActorOf(Props.Create(() => new KnockoutRichesGameLogic()),          "KnockoutRiches"));
            _dicGameLogicActors.Add(GAMEID.JackTheGiantHunter,  Context.ActorOf(Props.Create(() => new JackTheGiantHunterGameLogic()),      "JackTheGiantHunter"));
