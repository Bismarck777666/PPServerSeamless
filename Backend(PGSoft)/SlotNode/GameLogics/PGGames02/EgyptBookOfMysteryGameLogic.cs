...
{
    class EgyptBookOfMysteryGameLogic : BasePGSlotGame
    {
        ...
        protected override string DefaultResult
        {
            get
            {
                return "{\"si\":{\"wp\":null,\"twp\":null,\"bwp\":null,\"now\":10800,\"nowpr\":[5,3,6,6,4,5],\"snww\":null,\"lw\":null,\"trl\":[4,0,3,5],\"torl\":[4,0,3,5],\"orl\":[9,5,1,11,8,3,3,3,4,4,0,0,7,12,11,0,10,13,8,8,5,5,0,6,6,13,6,1,12,7],\"tptbr\":null,\"ptbr\":null,\"esb\":{\"1\":[5,6,7],\"2\":[8,9],\"3\":[20,21],\"4\":[23,24]},\"ebb\":{\"1\":{\"fp\":5,\"lp\":7,\"bt\":1,\"ls\":1},\"2\":{\"fp\":8,\"lp\":9,\"bt\":1,\"ls\":2},\"3\":{\"fp\":20,\"lp\":21,\"bt\":1,\"ls\":2},\"4\":{\"fp\":23,\"lp\":24,\"bt\":1,\"ls\":1}},\"es\":{\"1\":[5,6,7],\"2\":[8,9],\"3\":[20,21],\"4\":[23,24]},\"eb\":{\"1\":{\"fp\":5,\"lp\":7,\"bt\":1,\"ls\":1},\"2\":{\"fp\":8,\"lp\":9,\"bt\":1,\"ls\":2},\"3\":{\"fp\":20,\"lp\":21,\"bt\":1,\"ls\":2},\"4\":{\"fp\":23,\"lp\":24,\"bt\":1,\"ls\":1}},\"mcs\":0,\"mcsp\":null,\"mtrlcsp\":null,\"rs\":null,\"fs\":null,\"ssaw\":0.00,\"sc\":0,\"gwt\":0,\"fb\":null,\"ctw\":0.0,\"pmt\":null,\"cwc\":0,\"fstc\":null,\"pcwc\":0,\"rwsp\":null,\"ml\":3,\"cs\":0.05,\"rl\":[9,5,1,11,8,3,3,3,4,4,0,0,7,12,11,0,10,13,8,8,5,5,0,6,6,13,6,1,12,7],\"sid\":\"0\",\"psid\":\"0\",\"st\":1,\"nst\":1,\"pf\":0,\"aw\":0.00,\"wid\":0,\"wt\":\"C\",\"wk\":\"0_C\",\"wbn\":null,\"wfg\":null,\"blb\":0.00,\"blab\":0.00,\"bl\":1.85,\"tb\":0.00,\"tbb\":0.00,\"tw\":0.00,\"np\":0.00,\"ocr\":null,\"mr\":null,\"ge\":null}}";
            }
        }
        protected override string ErrorResultString
        {
            get { return "{\"wp\":null,\"twp\":null,\"bwp\":null,\"now\":3600,\"nowpr\":[5,3,3,4,4,5],\"snww\":null,\"lw\":null,\"trl\":[9,10,0,10],\"torl\":[9,10,0,10],\"orl\":[10,11,13,7,11,5,5,5,11,11,8,8,8,8,12,11,11,4,4,4,6,6,5,5,10,7,7,13,11,11],\"tptbr\":null,\"ptbr\":null,\"esb\":{\"1\":[5,6,7],\"2\":[8,9],\"3\":[10,11,12,13],\"4\":[17,18,19],\"5\":[20,21],\"6\":[22,23]},\"ebb\":{\"1\":{\"fp\":5,\"lp\":7,\"bt\":2,\"ls\":1},\"2\":{\"fp\":8,\"lp\":9,\"bt\":2,\"ls\":2},\"3\":{\"fp\":10,\"lp\":13,\"bt\":2,\"ls\":2},\"4\":{\"fp\":17,\"lp\":19,\"bt\":2,\"ls\":2},\"5\":{\"fp\":20,\"lp\":21,\"bt\":2,\"ls\":2},\"6\":{\"fp\":22,\"lp\":23,\"bt\":2,\"ls\":1}},\"es\":{\"1\":[5,6,7],\"2\":[8,9],\"3\":[10,11,12,13],\"4\":[17,18,19],\"5\":[20,21],\"6\":[22,23]},\"eb\":{\"1\":{\"fp\":5,\"lp\":7,\"bt\":2,\"ls\":1},\"2\":{\"fp\":8,\"lp\":9,\"bt\":2,\"ls\":2},\"3\":{\"fp\":10,\"lp\":13,\"bt\":2,\"ls\":2},\"4\":{\"fp\":17,\"lp\":19,\"bt\":2,\"ls\":2},\"5\":{\"fp\":20,\"lp\":21,\"bt\":2,\"ls\":2},\"6\":{\"fp\":22,\"lp\":23,\"bt\":2,\"ls\":1}},\"mcs\":-1,\"mcsp\":null,\"mtrlcsp\":null,\"rs\":null,\"fs\":null,\"ssaw\":0.0,\"sc\":0,\"gwt\":-1,\"fb\":null,\"ctw\":0.0,\"pmt\":null,\"cwc\":0,\"fstc\":null,\"pcwc\":0,\"rwsp\":null,\"hashr\":null,\"ml\":3,\"cs\":0.05,\"rl\":[10,11,13,7,11,5,5,5,11,11,8,8,8,8,12,11,11,4,4,4,6,6,5,5,10,7,7,13,11,11],\"sid\":\"1762869754630033410\",\"psid\":\"1762869754630033410\",\"st\":1,\"nst\":1,\"pf\":1,\"aw\":0.0,\"wid\":0,\"wt\":\"C\",\"wk\":\"0_C\",\"wbn\":null,\"wfg\":null,\"blb\":0.0,\"blab\":0.0,\"bl\":0.0,\"tb\":0.0,\"tbb\":0.0,\"tw\":0.0,\"np\":0.0,\"ocr\":null,\"mr\":null,\"ge\":[1,11]}"; }
        }
        ...
        public EgyptBookOfMysteryGameLogic()
        {
            _gameID  = GAMEID.EgyptBookOfMystery;
            GameName = "EgyptBookOfMystery";
        }
        ...
        private void onFreespinSelect(string strUserID, int websiteID, GITMessage message, double userBalance, BasePGSlotBetInfo betInfo, BasePGSlotStartSpinData startSpinData, bool isAffiliate)
        {
            try
            {
                ...
                var strGlobalUserID     = string.Format("{0}_{1}", websiteID, strUserID);
                if (!_dicUserResultInfos.ContainsKey(strGlobalUserID) || fss < 0 || fss > 3)
                    return;
            ...
            {
                _logger.Error("Exception has been occurred in EgyptBookOfMysteryGameLogic::onGambleCollect {0}", ex);
            }
        }
        ...
        protected override async Task<BasePGSlotSpinData> selectRandomStartFreeSpinData(BasePGSlotBetInfo betInfo)
        {
            try
            {
                var spinDataDocument = await Context.System.ActorSelection("/user/spinDBReaders").Ask<BsonDocument>(
                        new SelectPurchaseSpinRequest(GameName, StartSpinSearchTypes.SPECIFIC),
        ...
        protected override async Task<BasePGSlotSpinData> selectMinStartFreeSpinData(BasePGSlotBetInfo betInfo)
        {
            ...
            {                
                var spinDataDocument = await Context.System.ActorSelection("/user/spinDBReaders").Ask<BsonDocument>(
                            new SelectSelFreeMinStartRequest(GameName, 0), TimeSpan.FromSeconds(10.0));
