...
{
    class VampiresCharmGameLogic : BasePGSlotGame
    {
        ...
        protected override string DefaultResult
        {
            get
            {
                return "{\"si\":{\"wp\":null,\"lw\":null,\"ct\":0,\"esi\":-1,\"sw\":0.0,\"esw\":0.0,\"rs\":null,\"fs\":null,\"bns\":null,\"sc\":0,\"gwt\":0,\"fb\":null,\"ctw\":0.0,\"pmt\":null,\"cwc\":0,\"fstc\":null,\"pcwc\":0,\"rwsp\":null,\"hashr\":null,\"ml\":10,\"cs\":0.2,\"rl\":[10,4,7,2,8,3,7,0,6,2,8,3,10,4,7],\"sid\":\"0\",\"psid\":\"0\",\"st\":1,\"nst\":1,\"pf\":0,\"aw\":0.00,\"wid\":0,\"wt\":\"C\",\"wk\":\"0_C\",\"wbn\":null,\"wfg\":null,\"blb\":0.00,\"blab\":0.00,\"bl\":22.14,\"tb\":0.00,\"tbb\":0.00,\"tw\":0.00,\"np\":0.00,\"ocr\":null,\"mr\":null,\"ge\":null}}";
            }
        }
        ...
        public VampiresCharmGameLogic()
        {
            _gameID = GAMEID.VampiresCharm;
            GameName = "VampiresCharm";
        }
        ...
        protected override void convertWinsByBet(dynamic jsonParams, float currentBet)
        {
            ...
            if (!IsNullOrEmpty(jsonParams["esw"]))
                jsonParams["esw"] = convertWinByBet((double)jsonParams["esw"], currentBet);
