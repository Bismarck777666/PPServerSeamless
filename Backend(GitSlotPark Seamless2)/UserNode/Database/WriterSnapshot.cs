...
namespace UserNode.Database
{
    ...
    public class ApiTransactionItem 
    {
        ...
        public ApiTransactionItem(string agentID, string userID, int gameID, double betAmount, double winAmount, string transactionID, string relTransactionID, string platformTransID, string roundID, TransactionTypes transactionType, DateTime timestamp)
        {
            this.AgentID            = agentID;
            this.UserID             = userID;
            this.GameID             = gameID;
