...
{
    class StarlightPrincessGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public StarlightPrincessGameLogic()
        {
            _gameID = GAMEID.StarlightPrincess;
            GameName = "StarlightPrincess";
        }
