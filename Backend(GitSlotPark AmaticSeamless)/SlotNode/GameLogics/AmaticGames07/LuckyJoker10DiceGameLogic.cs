...
{
    class LuckyJoker10DiceGameLogic : BaseAmaticExtra1Game
    {
        #region 게임고유속성값
        ...
        public LuckyJoker10DiceGameLogic()
        {
            _gameID     = GAMEID.LuckyJoker10Dice;
            GameName    = "LuckyJoker10Dice";
        }
    }
}
