...
namespace SlotGamesNode.GameLogics
{
    ...
    class DiamondMonkeyGameLogic : BaseAmaticMultiBaseGame
    {
        ...
        protected override string buildInitString(string strGlobalUserID, double balance, Currencies currency)
        {
            ...
            DiamondMonkeyInitPacket grandInitPacket = new DiamondMonkeyInitPacket(initString, Cols, FreeCols, ReelSetColBitNum, ReelSetBitNum, (int)LINES.Last());
        ...
        public class DiamondMonkeyInitPacket : InitPacket
        {
            ...
            public DiamondMonkeyInitPacket(string message, int reelCnt, int freeReelCnt,int reelsetColBitCnt, int reelsetBitCnt, int lines) : base(message, reelCnt, freeReelCnt, reelsetColBitCnt, reelsetBitCnt)
            {
                extrawin        = 0;
                extrawildsymbol = 0;
