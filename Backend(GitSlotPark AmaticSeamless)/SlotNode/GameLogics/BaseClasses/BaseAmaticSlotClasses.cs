...
namespace SlotGamesNode.GameLogics
{
    ...
    public class BaseAmaticSlotBetInfo
    {
        ...
        public int          PlayBet             { get; set; }   //下注步骤
        ...
        public bool         GambleHalf          { get; set; }   //赌博半
        ...
        public void pushFrontResponse(BaseAmaticActionToResponse response)
        {
    ...
    public class BaseAmaticExtra21InitPacket : InitPacket
    {
        ...
        public BaseAmaticExtra21InitPacket(string message, int reelCnt, int freeReelCnt, int reelsetColBitCnt, int reelsetBitCnt, string extraStr) : base(message, reelCnt, freeReelCnt, reelsetColBitCnt, reelsetBitCnt)
        {
            extrastr    = extraStr;
            curpoint    = curpoint + extrastr.Length;
        }
