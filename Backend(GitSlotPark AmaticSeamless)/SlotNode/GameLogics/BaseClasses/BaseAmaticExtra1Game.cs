    ...
    public class BaseAmaticExtraWildInitPacket : InitPacket
        {
            ...
            public BaseAmaticExtraWildInitPacket(string message, int reelCnt, int freeReelCnt, int reelsetColBitCnt, int reelsetBitCnt, string extraStr) : base(message, reelCnt, freeReelCnt, reelsetColBitCnt, reelsetBitCnt)
            {
                extrastr    = extraStr;
                curpoint    = curpoint + extrastr.Length;
            }
