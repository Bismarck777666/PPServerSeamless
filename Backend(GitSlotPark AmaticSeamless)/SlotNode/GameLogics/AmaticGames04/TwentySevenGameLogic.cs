...
{
    public class TwentySevenBetInfo : BaseAmaticSlotBetInfo
    {
        public override int RelativeTotalBet    => 1;
    }

    class TwentySevenGameLogic : BaseAmaticSlotGame
    {
        #region 게임고유속성값
        ...
        protected override string InitString
        {
            get
            {
                return "";
            }
        }
        #endregion

        public TwentySevenGameLogic()
        {
            _gameID     = GAMEID.TwentySeven;
            GameName    = "TwentySeven";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strUserID, Currencies currency)
        {
            try
            {
                TwentySevenBetInfo betInfo   = new TwentySevenBetInfo();
                ...
                {
                    _logger.Error("{0} betInfo 0 or infinite in TwentySevenGameLogic::readBetInfoFromMessage", strUserID);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in TwentySevenGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
