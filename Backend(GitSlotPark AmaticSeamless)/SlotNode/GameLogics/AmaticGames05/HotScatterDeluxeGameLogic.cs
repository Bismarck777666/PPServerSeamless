...
namespace SlotGamesNode.GameLogics
{
    ...
    class HotScatterDeluxeGameLogic : BaseAmaticSlotGame
    {
        #region 게임고유속성값
        ...
        public HotScatterDeluxeGameLogic()
        {
            _gameID     = GAMEID.HotScatterDeluxe;
            GameName    = "HotScatterDeluxe";
        }
    }
}
