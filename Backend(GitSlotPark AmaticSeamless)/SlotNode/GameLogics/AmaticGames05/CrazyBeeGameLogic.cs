...
namespace SlotGamesNode.GameLogics
{
    ...
    class CrazyBeeGameLogic : BaseAmaticSlotGame
    {
        ...
        protected override string buildInitString(string strGlobalUserID, double balance, Currencies currency)
        {
            ...
            CrazyBeeInitPacket extraInitPacket = new CrazyBeeInitPacket(initString, Cols, FreeCols, ReelSetColBitNum, ReelSetBitNum);
        ...
        public class CrazyBeeInitPacket : InitPacket
        {
            ...
            public CrazyBeeInitPacket(string message, int reelCnt, int freeReelCnt, int reelsetColBitCnt, int reelsetBitCnt) : base(message, reelCnt, freeReelCnt, reelsetColBitCnt, reelsetBitCnt)
            {
                extrawin = 0;
                curpoint = curpoint + 2;
            }
