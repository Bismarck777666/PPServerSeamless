    ...
    class DiaMuertosGameLogic : BaseAmaticSlotGame
    {
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo 0 or infinite in DiaMuertosGameLogic::readBetInfoFromMessage", strGlobalUserID);
                    return;
                }
        ...
        protected override string buildInitString(string strGlobalUserID, double balance, Currencies currency)
        {
            ...
            DiaMuertosInitPacket respinInitPacket = new DiaMuertosInitPacket(initString, Cols, FreeCols, ReelSetColBitNum, ReelSetBitNum);
        ...
        public class DiaMuertosInitPacket : InitPacket
        {
            ...
            public DiaMuertosInitPacket(string message, int reelCnt, int freeReelCnt, int reelsetColBitCnt, int reelsetBitCnt) : base(message, reelCnt, freeReelCnt, reelsetColBitCnt, reelsetBitCnt)
            {
                accwin      = 0;
                respintype  = "00";
                curpoint    = curpoint + 2 + respintype.Length;
