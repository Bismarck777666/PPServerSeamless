...
{
    class MistressOfMonstersGameLogic : BaseAmaticMultiBaseExtra1Game
    {
        #region 게임고유속성값
        ...
        public MistressOfMonstersGameLogic()
        {
            _gameID     = GAMEID.MistressOfMonsters;
            GameName    = "MistressOfMonsters";
        }
