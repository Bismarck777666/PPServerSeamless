...
namespace SlotGamesNode.GameLogics
{
    class BookOfAztecDiceGameLogic : BaseAmaticSlotGame
    {
        ...
        protected override string buildInitString(string strGlobalUserID, double balance, Currencies currency)
        {
            ...
            BookOfAztecDiceInitPacket initPacket = new BookOfAztecDiceInitPacket(initString, Cols, FreeCols, ReelSetColBitNum, ReelSetBitNum, (int)LINES.Last());
        ...
        public class BookOfAztecDiceInitPacket : InitPacket
        {
            ...
            public BookOfAztecDiceInitPacket(string message, int reelCnt, int freeReelCnt, int reelsetColBitCnt, int reelsetBitCnt, int lines) : base(message, reelCnt, freeReelCnt, reelsetColBitCnt, reelsetBitCnt)
            {
                extrawildsymbol = 0;
                extracolcnt     = 0;
                extrawin        = 0;
