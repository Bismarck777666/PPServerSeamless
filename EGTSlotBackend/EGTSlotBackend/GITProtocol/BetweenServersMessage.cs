...
namespace GITProtocol
{
    ...
    public class FromHttpRevMessage
    {
        public GITMessage Message { get; private set; }
        
        public FromHttpRevMessage(GITMessage message)
        {
            this.Message = message;
        }
    }
    ...
    public class EGTExitResponse : ExitGameResponse
    {
        public ToUserResultMessage ResultMsg { get; set; }
        public EGTExitResponse(ToUserResultMessage resultMsg)
        {
    ...
    public class FromUserMessage
    {
        ...
        public int          WebsiteID       { get; private set; }   // Website Id
        public GITMessage   Message         { get; private set; }   // Message from client
        public double       UserBalance     { get; private set; }   // User Balance
        public IActorRef    UserActor       { get; private set; }   // User Actor
        public Currencies   Currency        { get; private set; }   // User Currency
