...
{
    class GatesOfOlympusDiceGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public GatesOfOlympusDiceGameLogic()
        {
            _gameID = GAMEID.GatesOfOlympusDice;
            GameName = "GatesOfOlympusDice";
        }
