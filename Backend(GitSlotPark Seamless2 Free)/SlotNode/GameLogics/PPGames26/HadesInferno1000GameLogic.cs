...
{
    class HadesInferno1000GameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        public HadesInferno1000GameLogic()
        {
            _gameID     = GAMEID.HadesInferno1000;
            GameName    = "HadesInferno1000";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in HadesInferno1000GameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
		
                if (betInfo.MoreBet && betInfo.PurchaseFree)
                {
                    _logger.Error("{0} betInfo.MoreBet and  PurchasedFreeSpin is same time true in HadesInferno1000GameLogic::readBetInfoFromMessage", strGlobalUserID);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in HadesInferno1000GameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
