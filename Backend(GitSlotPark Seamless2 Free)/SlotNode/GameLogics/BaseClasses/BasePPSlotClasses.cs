...
namespace SlotGamesNode.GameLogics
{
    ...
    public class PPFreeSpinInfo
    {
        ...
        public PPFreeSpinInfo(long bonusID, int remainCount, double betPerLine, double totalWin, bool pending, DateTime expireTime, string freeSpinID)
        {
            BonusID     = bonusID;
        ...
        public void SerializeFrom(BinaryReader reader)
        {
            ...
            this.FreeSpinID     = reader.ReadString();
        }
