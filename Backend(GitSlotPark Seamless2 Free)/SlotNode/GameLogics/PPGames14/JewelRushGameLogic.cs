...
{
    class JewelRushGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public JewelRushGameLogic()
        {
            _gameID = GAMEID.JewelRush;
            GameName = "JewelRush";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in JewelRushGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in JewelRushGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
