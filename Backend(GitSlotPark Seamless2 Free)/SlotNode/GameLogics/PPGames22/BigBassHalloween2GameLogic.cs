...
{
    class BigBassHalloween2GameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        public BigBassHalloween2GameLogic()
        {
            _gameID     = GAMEID.BigBassHalloween2;
            GameName    = "BigBassHalloween2";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in vs10bhallbnza2GameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in vs10bhallbnza2GameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
    }
}
