...
{
    class BookOfTutGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public BookOfTutGameLogic()
        {
            _gameID = GAMEID.BookOfTut;
            GameName = "BookOfTut";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in BookOfTutGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in BookOfTutGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
        ...
        protected void onDoMysteryScatter(int agentID, string strUserID, GITMessage message, UserBonus userBonus, double userBalance)
        {
            ...
            {
                _logger.Error("Exception has been occurred in BookOfTutGameLogic::onDoMysteryScatter {0}", ex);
            }
        }
