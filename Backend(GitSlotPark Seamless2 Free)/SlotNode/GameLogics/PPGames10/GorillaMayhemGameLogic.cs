...
{
    class GorillaMayhemGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public GorillaMayhemGameLogic()
        {
            _gameID = GAMEID.GorillaMayhem;
            GameName = "GorillaMayhem";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in GorillaMayhemGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in GorillaMayhemGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
