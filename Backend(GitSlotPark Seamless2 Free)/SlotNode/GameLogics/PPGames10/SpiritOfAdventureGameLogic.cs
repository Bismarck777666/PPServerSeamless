...
namespace SlotGamesNode.GameLogics
{
    ...
    class SpiritOfAdventureGameLogic : BasePPSlotGame
    {
        ...
        {
            return new SpiritOfAdventureBetInfo();
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in SpiritOfAdventureGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
        ...
        protected override async Task overrideResult(BasePPSlotBetInfo baseBetInfo, BasePPSlotSpinResult baseResult, int agentID, bool isAffiliate)
        {
            ...
            GambleOdd   gambleOdd   = pickGambleOdd(agentID, isAffiliate);
            double      gambleWin   = Math.Round(possibleWin * gambleOdd.RealOdd, 2);
            
            if (!isAffiliate && !await checkWebsitePayoutRate(agentID, possibleWin, gambleWin, 1))
            {
        ...
        private GambleOdd pickGambleOdd(int agentID, bool isAffiliate)
        {
