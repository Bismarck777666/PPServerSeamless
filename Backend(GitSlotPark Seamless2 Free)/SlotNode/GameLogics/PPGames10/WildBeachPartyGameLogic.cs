...
{
    class WildBeachPartyGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public WildBeachPartyGameLogic()
        {
            _gameID = GAMEID.WildBeachParty;
            GameName = "WildBeachParty";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in WildBeachPartyGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in WildBeachPartyGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
