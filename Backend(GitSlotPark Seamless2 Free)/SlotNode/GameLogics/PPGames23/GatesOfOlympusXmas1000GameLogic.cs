...
{
    class GatesOfOlympusXmas1000GameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        public GatesOfOlympusXmas1000GameLogic()
        {
            _gameID = GAMEID.GatesOfOlympusXmas1000;
            GameName = "GatesOfOlympusXmas1000";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in vs20olympxmasGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
		
                if (betInfo.MoreBet && betInfo.PurchaseFree)
                {
                    _logger.Error("{0} betInfo.MoreBet and  PurchasedFreeSpin is same time true in vs20olympxmasGameLogic::readBetInfoFromMessage", strGlobalUserID);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in vs20olympxmasGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
    }
}
