...
{
    class JourneyToTheWestGameLogic : BaseSelFreePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public JourneyToTheWestGameLogic()
        {
            _gameID = GAMEID.JourneyToTheWest;
            GameName = "JourneyToTheWest";
        }
