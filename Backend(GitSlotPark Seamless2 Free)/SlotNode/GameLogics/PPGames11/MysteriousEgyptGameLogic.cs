...
{
    class MysteriousEgyptGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public MysteriousEgyptGameLogic()
        {
            _gameID = GAMEID.MysteriousEgypt;
            GameName = "MysteriousEgypt";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in MysteriousEgyptGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in MysteriousEgyptGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
        ...
        protected void onDoMysteryScatter(int agentID, string strUserID, GITMessage message, UserBonus userBonus, double userBalance)
        {
            ...
            {
                _logger.Error("Exception has been occurred in MysteriousEgyptGameLogic::onDoMysteryScatter {0}", ex);
            }
        }
