...
{
    class DragonKingdomGameLogic : BaseSelFreePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public DragonKingdomGameLogic()
        {
            _gameID  = GAMEID.DragonKingdom;
            GameName = "DragonKingdom";
        }
