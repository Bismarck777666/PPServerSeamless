...
{
    class FiveRabbitsMegaGameLogic : BaseSelFreePPSlotGame
    {
        #region 게임고유속성값
        ...
        public FiveRabbitsMegaGameLogic()
        {
            _gameID  = GAMEID.FiveRabbitsMega;
            GameName = "FiveRabbitsMega";
        }
