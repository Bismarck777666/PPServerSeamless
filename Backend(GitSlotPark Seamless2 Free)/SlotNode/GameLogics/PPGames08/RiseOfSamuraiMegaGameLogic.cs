...
{
    class RiseOfSamuraiMegaGameLogic : BasePPSlotGame
    {
        #region 게임고유속성값
        ...
        #endregion
        public RiseOfSamuraiMegaGameLogic()
        {
            _gameID = GAMEID.RiseOfSamuraiMega;
            GameName = "RiseOfSamuraiMega";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in RiseOfSamuraiMegaGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }

                if (betInfo.MoreBet && betInfo.PurchaseFree)
                {
                    _logger.Error("{0} betInfo.MoreBet and  PurchasedFreeSpin is same time true in RiseOfSamuraiMegaGameLogic::readBetInfoFromMessage", strGlobalUserID);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in RiseOfSamuraiMegaGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
