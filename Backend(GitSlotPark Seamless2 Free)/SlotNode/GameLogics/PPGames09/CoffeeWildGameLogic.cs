...
{
    class CoffeeWildGameLogic : BasePPSlotGame
    {
        ...
        #endregion
        public CoffeeWildGameLogic()
        {
            _gameID = GAMEID.CoffeeWild;
            GameName = "CoffeeWild";
        }
        ...
        protected override void readBetInfoFromMessage(GITMessage message, string strGlobalUserID, Currencies currency)
        {
            try
            {
                ...
                {
                    _logger.Error("{0} betInfo.BetPerLine <= 0 in CoffeeWildGameLogic::readBetInfoFromMessage {1}", strGlobalUserID, betInfo.BetPerLine);
                    return;
                }
            ...
            {
                _logger.Error("Exception has been occurred in CoffeeWildGameLogic::readBetInfoFromMessage {0}", ex);
            }
        }
