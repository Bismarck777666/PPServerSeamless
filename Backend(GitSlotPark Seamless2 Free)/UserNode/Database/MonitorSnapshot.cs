...
namespace UserNode.Database
{
    public class DBMonitorSnapshot
    {
        ...
        public long     LastFreeSpinEventID         { get; set; }
        public DateTime LastFreeSpinUpdateTime      { get; set; }
        ...
        public DBMonitorSnapshot()
        {
            ...
            this.LastFreeSpinEventID        = -1;
            this.LastRangeEventUpdateTime   = new DateTime(1, 1, 1);
            this.LastFreeSpinUpdateTime     = new DateTime(1, 1, 1);
