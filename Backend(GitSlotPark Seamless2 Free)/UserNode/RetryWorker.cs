...
namespace UserNode
{
    public class RetryWorker : ReceiveActor
    {
        ...
        private async Task<DepositResponse> onDeposit(DepositRequestWithRetry request)
        {
            try
            {
                ...
                depositRequest.freeSpinID       = request.FreeSpinID;
    ...
    public class DepositRequestWithRetry : CallbackApiRequestWithRetry
    {
        ...
        public DepositRequestWithRetry(string apiURL, string agentID, string userID, string secretKey, int gameID, int retryCount, DateTime lastTriedTime, string transactionID, string refTransactionID, string roundID, double amount, string freeSpinID) :
            base(apiURL, agentID, userID, secretKey, gameID, retryCount, lastTriedTime)
        {
            this.TransactionID      = transactionID;
