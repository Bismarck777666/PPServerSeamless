...
namespace SlotGamesNode.GameLogics
{
    ...
    public class BasePPSlotSpinResult
    {
        ...
        public List<string>         LastCard            { get; set; }
        ...
        public virtual double LastWinMoney
        {
            get
            {
                return this.LastTotalWin;
            }
        }
        public bool HasBonusResult
        {
            get { return !string.IsNullOrEmpty(BonusResultString); }
        }
        public virtual void SerializeTo(BinaryWriter writer)
        {
            writer.Write(this.TotalWin);
            writer.Write(this.LastTotalWin);
        ...
        public virtual void SerializeFrom(BinaryReader reader)
        {
            ...
            this.LastTotalWin       = reader.ReadDouble();
        ...
        public BasePPSlotSpinResult()
        {
            ...
            this.Round              =0;
            this.LastCard           = new List<string>();
        }
    }
    public class BasePPGambleData
    {
        public string status { get; set; }
        public double microtime { get; set; }
        public string dateTime { get; set; }
        public object error { get; set; }
        public gambleContent content { get; set; }
        public BasePPGambleData()
        {
            status = "success";
            microtime = 0.138095;
            error = null;
    ...
    public class gambleContent
    {
        ...
        public string actionNext { get; set; }
        public List<string> lastCard { get; set; }
        public int round { get; set; }
        public string hash { get; set; }
        public gambleContent()
        {
            cmd = "gameGamble";
            session = "17397369_760b3960056f";
            actionId = "actionId";
            hash = "eb3ff71c83";
        }
    }
    public class BasePPTakeWinData
    {
        public string status { get; set; }
        public double microtime { get; set; }
        public string dateTime { get; set; }
        public object error { get; set; }
        public TakeWinContent content { get; set; }
        public BasePPTakeWinData()
        {
            status = "success";
            microtime = 0.057536;
            error = null;
    ...
    public class BasePPSlotBetInfo
    {
        ...
        public virtual float TotalBet
        {
            get
            {
                return BetPerLine * LineCount * Denomination;
            }
        }
