...
namespace CommNode.Database
{
    public class DBProxyWriter : ReceiveActor
    {
        ...
        public DBProxyWriter(string strConnStriing)
        {
            ...
            Receive<PlayerBalanceResetItem>(updateItem =>
            {
                WriterSnapshot.Instance.updatePlayerBalanceReset(updateItem);
            });
            ...
            Receive<PPTourLeaderboardDBItem>(item =>
            {
                WriterSnapshot.Instance.insertUserTournamentLeaderItem(item);
            });
            ...
            Receive<List<PlayerBalanceResetItem>>(message =>
            {
                WriterSnapshot.Instance.PushBalanceResetItems(message);
            });            
            Receive<List<GameLogItem>>(message =>
            {
                WriterSnapshot.Instance.PushGameLogItems(message);
            });
            Receive<List<PPTourLeaderboardDBItem>>(message =>
            {
                WriterSnapshot.Instance.PushUserTournamentLeaderItems(message);
            });
        ...
        private void processCommand(string strCommand)
        {
            ...
            else if(strCommand == "PopBalanceResets")
            {
                List<PlayerBalanceResetItem> resetBalanceItems = WriterSnapshot.Instance.PopBalanceResets();
                Sender.Tell(resetBalanceItems);                
            }
            ...
            {
                List<PPTourLeaderboardDBItem> items = WriterSnapshot.Instance.PopPPTournamentLeaderItems();
                Sender.Tell(items);
            }
