...
description: Use when asked to plan out, break down, or organize a multi-step project, research task, or any work requiring 5+ tool calls. Implements Manus-style file-based planning with task_plan.md, findings.md, progress.md. Supports automatic session recovery after /clear.
user-invocable: true
